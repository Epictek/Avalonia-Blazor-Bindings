...
";
    ...
    private static GenerateComponentSettings[] GetTypesToGenerate(Compilation compilation)
    {
        ...
        var typesToGenerate = attributes
            .Where(a => a.AttributeClass?.ToDisplayString() == "BlazorBindingsAvalonia.ComponentGenerator.GenerateComponentAttribute")
            .Select(a =>
            {
        ...
        var typesByAssembly = attributes
            .Where(a => a.AttributeClass?.ToDisplayString() == "BlazorBindingsAvalonia.ComponentGenerator.GenerateComponentsFromAssemblyAttribute")
            .SelectMany(a =>
            {
